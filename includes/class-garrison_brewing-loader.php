...
class Garrison_brewing_Loader {
	...
	public function add_shortcode( $shortcode_name, $callback) {
		$this->shortcodes = $this->add_shortcode_method( $this->shortcodes, $shortcode_name,$callback);
	}
	...
	private function add_shortcode_method( $hooks, $shortcode_name, $callback) {
